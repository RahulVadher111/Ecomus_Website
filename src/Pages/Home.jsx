...
function Home() {
  return (
    <>
            ...
            >
              <div className="w-100">
                <div className="d-flex flex-column justify-content-center text-start p-5 banner-text">
                  ...
                  <p className="lead text-dark fw-semibold line">
            ...
            >
              <div className="w-100">
                <div className="d-flex flex-column justify-content-center text-start px-5 banner-text">
                  ...
                  <p className="lead text-dark fw-bold line">
                    From casual to formal, we’ve got you covered
                  </p>
                  <NavLink to="/Shopping_page">
                    <button className="btn btn-lg  px-4 mt-4  p-3 fs-6 text-white fw-bold bg-dark">
      ...
      <div
        className="scroll-wrapper p-4 "
        style={{ backgroundColor: "#FCFFB2" }}
      >
        <div className="scroll-content">
          <span>
            <i class="bi bi-lightning-fill"></i>Spring Clearance Event: Save Up
            to 70%
          </span>
          <span>
            <i class="bi bi-lightning-fill"></i>Spring Clearance Event: Save Up
