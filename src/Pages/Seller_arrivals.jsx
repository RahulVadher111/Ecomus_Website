  ...
  return (
    ...
    >
      ...
      <div style={{ borderRadius: "18px", overflow: "hidden", position: "relative" }}>
        ...
        >
            <button className="btn btn-light rounded"><i class="bi bi-bag-dash"></i></button>
            <button className="btn btn-light rounded"><i class="bi bi-heart"></i></button>
            <button className="btn btn-light rounded"><i class="bi bi-shuffle"></i></button>
            <button className="btn btn-light rounded"><i class="bi bi-eye"></i></button>
        </div>
        )}
