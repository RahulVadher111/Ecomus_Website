      ...
      <div className="container-fluid p-5 pb-0" >
        ...
        <div className="row gy-5 border-top border-2">
          ...
          <div className="col-lg-3 pb-3">
            <img src={logo} alt="Logo" className="footer-logo mb-4" style={{width:'130px'}} />

            <p className="footer-text pb-1">Address: 1234 Fashion Street, Suite 567,</p>
            <p className="footer-text pb-1">New York, NY 10001</p>

            <p className="footer-text text-semibold pb-1">
              Email: <a href="#" className="footer-link text-muted">info@fashionshop.com</a>
            </p>
            ...
            <p className="footer-direction mt-3 " style={{fontSize:"15px"}}>
         ...
         <a href="#" className="text-dark border rounded-circle p-1  facebook">
                <i class="bi bi-facebook p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1   twitter">
                <i class="bi bi-twitter-x p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1   instagram">
                <i class="bi bi-instagram p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1   tiktok">
                <i class="bi bi-tiktok p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1   pinterest">
          ...
          <div className="col-lg-3">
            ...
            <p className='footer-text-small pb-3'> exclusive content, events and more!</p>
        ...
        <div className="d-flex justify-content-between align-items-center flex-wrap pt-3 pb-1">
          <p className="footer-text m-0">© 2025 Ecomus Store. All Rights Reserved</p>
