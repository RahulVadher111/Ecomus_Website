  ...
  <div className="container-fluid py-1">
      <div className="container py-5">
        <div className="row mx-5">
          ...
          {/* RIGHT SIDE */}
          <div className="col-lg-6">
            <px className="mb-3 fs-2">Get in Touch</px>
            <p className=" mb-4 pt-3"style={{fontSize:"14px"}}>
            ...
            <form>
              ...
              <button className="btn text-white w-100 py-2" style={{backgroundColor:'#000000'}}>
                Send
              </button>
            </form>
          </div>
...
export default Pages_Contact_us
