    ...
    <>
            ...
            {activeHotspot === 1 && (
              <div className="hotspot-card" style={{ top: "40%", left: "48%" }}>
                <div className="d-flex align-items-center gap-4">
                  ...
                  />
                  <div>
                    <h6 className="m-0 fw-semibold icon-box">
      ...
      <div className="my-5 pt-5 ">
        ...
        <div className="container-fluid position-relative p-5 pb-0">
          {/* Arrow Controls */}
          <button ref={prevRef} className="slider-arrow left-arrow">
            ‹
          </button>
          <button ref={nextRef} className="slider-arrow right-arrow">
            ›
          </button>
        ...
        <div className="brand-box  rounded-4 border">
          <div className="row g-0 text-center">
            {brandList.map((brand) => (
              <div
                key={brand.id}
                className="col-6 p-4 col-md-4 col-lg-2 border-end brand-item d-flex justify-content-center align-items-center"
              >
                <img
                  src={brand.img}
                  alt="brand"
