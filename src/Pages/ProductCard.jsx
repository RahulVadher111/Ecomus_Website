...
import Seller_arrivals from "./Seller_arrivals";
  ...
  return (
    <>
      <div className="container-fluid mt-5 ">
        <div className="mx-3">
          <button href="#" className="btn small" style={{ fontSize: "14px" }}>
            Home <i class="bi bi-chevron-right"></i>
          </button>
          <button className="btn small" style={{ fontSize: "14px" }}>
            Women <i class="bi bi-chevron-right"></i>
          </button>
          <button className="btn small text-muted" style={{ fontSize: "14px" }}>
            Cotten jursy top{" "}
          </button>
        </div>
        <div className=" p-4 ">
          <div className="row">
              ...
              {images.map((img, index) => (
                <img
                  ...
                  className={`img-thumbnail mb-2 ${
                    currentIndex === index ? "border-dark" : ""
                  }`}
            ...
            <div className="col-md-5 position-relative">
              ...
              />
              <button
                className="btn  rounded-circle bg-light position-absolute top-50 start-0 translate-middle-y  mx-4 pb-2 bgred "
                onClick={handlePrev}
              >
                <i class="bi bi-chevron-left"></i>
              </button>
              <button
                className="btn   rounded-circle bg-light  position-absolute top-50 end-0 translate-middle-y mx-4 pb-2 bgred"
                onClick={handleNext}
              >
            ...
            <div className="col-md-6 p-5 pt-0">
              ...
              <div className="d-flex">
                <button className="badge bg-light border border-dark text-dark pb-0 pt-0">
                  Best Seller
                </button>
              ...
              <p className="text-danger h3 pt-4">
                $25.00 <del className="text-muted">$30.00</del>{" "}
                <span
                  className="badge rounded-4"
                  style={{ backgroundColor: "#FC5732" }}
                >
                  17% OFF
                </span>
              </p>
              ...
              <div className="mb-3 pt-2">
                {/* Label stays on top */}
                <label className="form-label d-block mb-2">Size : {size}</label>
                ...
                <div className="btn-group pb-2">
                  {["M", "L", "XL"].map((s) => (
                    <button
                      key={s}
                      className={`btn btn-outline-dark border-0 rounded-1 mx-2 ${
                        size === s ? "active" : ""
                      }`}
                      onClick={() => setSize(s)}
                    >
              ...
              <div className="d-grid gap-2 mb-3">
                <div className="pb-2">
                  <button className="btn btn-dark w-75 p-2 fw-bold">
                    Add to cart – ${25.0 * quantity}
                  </button>
                ...
                <button className="btn btn-warning text-muted p-2">
                  {" "}
                  Buy with <img src={paypal} alt="" />
                </button>
                <div className="text-center">
                  <a
                    href="#"
                    className="text-muted d-inline border-2 border-muted pb-1 "
                  >
              ...
              <div className="d-flex justify-content-between text-bold small pt-3">
                <span>
                  <i class="bi bi-palette-fill"></i> Compare color
                </span>
                <span>
                  <i class="bi bi-question-circle"></i> Ask a question
                </span>
                <span>
                  <i class="bi bi-truck"></i> Delivery & Return
                </span>
                <span>
              ...
              <div className="pt-5">
                <div className="d-flex justify-content-center gap-4 flex-wrap">
                  ...
                  <div className="text-center border p-4 flex-fill">
                    ...
                    <p style={{ fontSize: "15px" }}>
                      Return within <span className="fw-bold">30 days</span> of
                      purchase. <br />
            ...
            >
              <div className=" card-body">
                <p className=" mb-4" style={{ color: "#000000" }}>
                  ...
                  tailored with drapey, crinkle-texture fabric that’s made from
                  LENZING™ ECOVERO™ Viscose — responsibly sourced wood-based
                  fibres produced through a process that reduces impact on
                  forests, biodiversity and water supply.
                </p>

                <div className="row">
                  <div className="col-md-5">
                    <h6 className="pb-3 pt-3">Features</h6>
                    <ul className="text-muted" style={{ color: "#909090" }}>
                      <li className="pb-3">Front button placket</li>
                      <li className="pb-3">Adjustable sleeve tabs</li>
                      <li className="pb-3">
                        Babaton embroidered crest at placket and hem
                      </li>
                    </ul>

                    <h6 className="mt-4 pb-3">Materials Care</h6>
                    <ul className="text-muted" style={{ color: "#909090" }}>
                      <li className="pb-3">
                        Content: 100% LENZING™ ECOVERO™ Viscose
                      </li>
                      <li className="pb-3">Care: Hand wash</li>
                      <li className="pb-3">Imported</li>
                    </ul>
                  </div>

                  <div className="col-md-6">
                    <h6 className="pt-3">Materials Care</h6>

                    <div
                      className="d-flex mb-3 pt-3"
                      style={{ color: "#909090" }}
                      x
                    >
                      <svg
                        ...
                        color="#222"
                        margin="5px"
                        className="rounded-circle  border border-dark p-1 me-3"
                      >
                        <path
                          fill="currentColor"
                    ...
                    <div className="d-flex mb-3" style={{ color: "#909090" }}>
                      <svg
                        viewBox="0 0 40 40"
                        width="35px"
                        height="35px"
                    ...
                    <div className="d-flex" style={{ color: "#909090" }}>
                      <svg
                        viewBox="0 0 40 40"
                        width="35px"
                        height="35px"
                ...
                <div className="container my-4">
                  <div className="border rounded overflow-hidden">
                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-9 p-3 text-muted">S, M, L, XL</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="container my-5">
                  ...
                  <div className="row align-items-start mb-5">
                    ...
                    {/* MIDDLE */}
                    <div className="col-md-4 pt-4 fs-6">
                      {[5, 4, 3, 2, 1].map((star) => (
                        <div
                          className="d-flex align-items-center mb-2"
                          key={star}
                        >
                          <span className="me-2 fs-5">{star} ★</span>
                          <div
                            className="progress flex-grow-1 rounded-0"
                            style={{ height: "9px" }}
                          >
                            <div
                    ...
                    {/* RIGHT */}
                    <div className="col-md-6  pt-5 mt-4 text-end">
                      <button className="btn border-dark px-4 review">
                        Write a review
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="d-flex mb-5">
                    ...
                    />
                    <div>
                      <h5 className="text-dark colorred">
                      ...
                      <p className="mt-3 text-muted">
                        ...
                        built in features and flexibility and this was perfect.
                        We expected to need to employ a developer to add a few
                        finishing touches. But we actually managed to do
                        everything ourselves. We did have one small query and
                        the support given was swift and helpful.
                      </p>

                      {/* REPLY */}
                      <div className="d-flex mt-4 ps-4 border-start border-4">
                        <img
                          src={review_2}
                        ...
                        />
                        <div>
                          <h6 className="fw-bold colorred">
                            Reply from Modave
                          </h6>
                          <small className="text-muted">1 days ago</small>
                          <p className="mt-2 text-muted">
                            We love to hear it! Part of what we love most about
                            Modave is how much it empowers store owners like
            ...
            >
              <div className=" card-body">
                <div className="container-fluid pt-3">
                  ...
                  >
                    <p className="pb-2" style={{ color: "#909090" }}>
