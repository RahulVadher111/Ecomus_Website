        ...
        <div className="row g-4">
          ...
          <div className="col-md-3 col-sm-6 col-12">
            <div className=" text-center p-4 border rounded-4">
              ...
              <p className=" small mb-0">Free shipping over order $120</p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6 col-12">
            <div className=" text-center p-4 border rounded-4">
              ...
              <p className=" small mb-0">Pay with Multiple Credit Cards</p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6 col-12">
            <div className=" text-center p-4 border rounded-4">
              ...
              <p className=" small mb-0">Within 30 days for an exchange</p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6 col-12">
            <div className=" text-center p-4 border rounded-4">
              ...
              <p className=" small mb-0">Outstanding premium support</p>
            </div>
          </div>
        </div>
      </div>
