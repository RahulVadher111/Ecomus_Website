...
function Navbar() {
  ...
  const [selectedFlag, setSelectedFlag] = useState("https://flagcdn.com/w20/us.png");
    ...
    <div className='container-fluid'>
        <div className='row text-center p-2 pt-1 mx-2'>
            <div className="d-flex gap-2 mt-2 roundedx-circle col-md-4 gap-2 ">
              <a href="#" className="text-dark border rounded-circle p-1 cricleicone facebook">
                <i class="bi bi-facebook p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1  cricleicone twitter">
                <i class="bi bi-twitter-x p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1  cricleicone instagram">
                <i class="bi bi-instagram p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1  cricleicone tiktok">
                <i class="bi bi-tiktok p-1"></i>
              </a>
              <a href="#" className="text-dark border rounded-circle p-1  cricleicone pinterest">
           ...
           <div className="col-md-4 d-flex align-items-center justify-content-center">
                ...
                >
                  <SwiperSlide>
                    <p className="text-center fw-semibold m-0" style={{ fontSize: "14px" }}>
                  ...
                  <SwiperSlide>
                    <p className="text-center fw-semibold m-0" style={{ fontSize: "14px" }}>
                      Spring Fashion sale  <span className='text-danger border-bottom border-danger'>Shope now <i class="bi bi-arrow-up-right"></i> </span> 
                    </p>
                  </SwiperSlide>
            ...
            <div className="row align-items-center  mx-3 pt-2">
              ...
              style={{fontFamily: "Albert Sans, sans-serif"}}>
                <ul className="nav">
                  ...
                  >
                     <a className="nav-link text-dark hover" >Home <i className="bi bi-chevron-down Small"></i></a>
                    ...
                    >
                      <div className="container py-4">
                        <div className=" row text-center  d-flex flex-wrap" style={{fontSize:"17px"}}>
                          {/* 6 Images (2 rows x 3 cols) */}
                          <div className="col-md-2 mb-3 bg-light p-2 hoverborder">
                            <img src={home_01} className="img-fluid  rounded zoom-img" alt="Home 1" />
                            <p className="mt-2 dark">Home fashion 01</p>
                          </div>
                          <div className="col-md-2 mb-3 bg-light p-2 hoverborder">
                            <img src={home_02} className="img-fluid  rounded zoom-img" alt="Home 2" />
                            <p className="mt-2 dark">Home multi brand</p>
                          </div>
                          <div className="col-md-2 mb-3 bg-light p-2 hoverborder">
                            <img src={home_03} className="img-fluid  rounded zoom-img" alt="Home 3" />
                            <p className="mt-2 dark">Home fashion 02</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_04} className="img-fluid  rounded zoom-img" alt="Home 4" />
                            <p className="mt-2 dark">Home fashion 03</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_05} className="img-fluid  rounded zoom-img" alt="Home 5" />
                            <p className="mt-2 dark">Home fashion 04</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_06} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home fashion 05</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_07} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home fashion 06</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_08} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home drinkwear</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_09} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home Supplement</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_010} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home personalized pod</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">        
                            <img src={home_011} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home pickleball</p>
                          </div>
                          <div className="col-md-2 bg-light p-2 hoverborder">
                            <img src={home_012} className="img-fluid  rounded zoom-img" alt="Home 6" />
                            <p className="mt-2 dark">Home Ceramic</p>
                          </div>
                          <div className='pt-4'>
                            <button className='btn btn-dark p-3 fw-bold'>
                              view all demoes (48+) <i class="bi bi-chevron-right"></i>
                            </button>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <a className="nav-link text-dark hover">Shop <i className="bi bi-chevron-down Small"></i></a>
                          ...
                          <div className="col-md-12 d-flex p-4 ">
                            ...
                            <div className="col-md-2" style={{fontSize:"14px"}}>
                              ...
                              <ul className="list-unstyled text-muted">
                                ...
                                <li className="pb-3 shope">Pagination loadmore</li>
                                <li className="pb-3 shope">Pagination infinite scrolling</li>
                            ...
                            <div className="col-md-2 " style={{fontSize:"14px"}}>
                              <h6 className=" pb-3 fw-semibold">Product styles</h6>
                              <ul className="list-unstyled text-muted">
                      ...
                      <div className="container py-4">
                        <div className="row gx-4">
                          ...
                          <div className="col-lg-8 d-flex">
                            <div className="row w-100 gx-3">
                              ...
                              <div className="col-md-3" style={{fontSize:"14px"}}>
                                <h6 className="fw-semibold pb-2">Product layouts</h6>
                                <ul className="list-unstyled text-muted">
                                  ...
                                  <li className="pb-3 shope">Product right thumbnails</li>
                                  <li className="pb-3 shope">Product drawer sidebar</li>
                                  <li className="pb-3 shope">Product description accordion</li>
                                  <li className="pb-3 shope">Product description list</li>
                                  <li className="pb-3 shope">Product description vertical</li>
                                </ul>
                              </div>

                              {/* Column 2 */}
                              <div className="col-md-3" style={{fontSize:"14px"}}>
                                <h6 className="fw-semibold pb-2 shope">Product details</h6>
                                <ul className="list-unstyled text-muted">
                                  <li className="pb-3 shope">Product inner zoom</li>
                                  <li className="pb-3 shope">Product zoom magnifier</li>
                                  <li className="pb-3 shope">Product no zoom</li>
                                  <li className="pb-3 shope">Product photoswipe popup</li>
                                  <li className="pb-3 shope">
                                    Product external zoom and <br /> photoswipe popup
                                  </li>
                                  <li className="pb-3 shope">Product video</li>
                                  <li className="pb-3 shope">Product 3D, AR models</li>
                                  <li className="pb-3 shope">Product options & customizer</li>
                                  <li className="pb-3 shope">Advanced product types</li>
                                  <li className="pb-3 shope">
                                    Recipient info form for <br /> gift card products
                                  </li>
                                </ul>
                              </div>
                              ...
                              {/* Column 3 */}
                              <div className="col-md-3" style={{fontSize:"14px"}}>
                                <h6 className="fw-semibold pb-2 shope">Product swatches</h6>
                                <ul className="list-unstyled text-muted">
                                  <li className="pb-3 shope">Product color swatch</li>
                                  <li className="pb-3 shope">Product rectangle</li>
                                  <li className="pb-3 shope">Product rectangle color</li>
                                  <li className="pb-3 shope">Product swatch image</li>
                                  <li className="pb-3 shope">Product swatch image rounded</li>
                                  <li className="pb-3 shope">Product swatch dropdown</li>
                                  <li className="pb-3 shope">Product swatch dropdown color</li>
                                </ul>
                              </div>

                              {/* Column 4 */}
                              <div className="col-md-3" style={{fontSize:"14px"}}>
                                <h6 className="fw-semibold pb-2 shope">Product features</h6>
                                <ul className="list-unstyled text-muted">
                                  <li className="pb-3 shope">Frequently bought together</li>
                                  <li className="pb-3 shope">Frequently bought together </li>
                                  <li className="pb-3 shope">Product upsell features</li>
                                  <li className="pb-3 shope">Product pre-orders</li>
                                  <li className="pb-3 shope">Back in stock notification</li>
                                  <li className="pb-3 shope">Product pickup</li>
                                  <li className="pb-3 shope">Variant images grouped</li>
                                  <li className="pb-3 shope">Complimentary products</li>
                          ...
                          <div className="col-lg-4 d-flex gap-3 align-items-center justify-content-center">
                            ...
                            <div className='pt-4'>
                          <p>Ribbed Tank Top <br /> <span>$16.95</span></p>
                  ...
                  >
                   <a className="nav-link text-dark hover" >Pages <i className="bi bi-chevron-down Small"></i></a>


                    <ul
                      className={`dropdown-menu shadow p-4 border-0 mt-0 rounded-0 ${showPages ? "d-block" : ""}`}
                    ...
                    >
                      ...
                      <li className="dropdown-submenu position-relative pb-2">
                        ...
                        <ul className="dropdown-menu position-absolute top-0 start-100 border-0 p-3">
                          <li><a  className="dropdown-item shope " href="#">Brand </a></li>
                          <li><a className="dropdown-item shope " href="#">Brand V2</a></li>
                        </ul>
                      </li>

                      <li className="dropdown-submenu position-relative pb-2">
                        <a  className="dropdown-item shope" href="#">
                          Contact <i className="bi bi-chevron-right float-end"></i>
                        </a>
                        <ul className="dropdown-menu position-absolute top-0 start-100 border-0 p-3">
                          <li><a  className="dropdown-item shope " href="#">Contact 1 </a></li>
                          <li><a className="dropdown-item shope " href="#">Contact 2</a></li>
                        </ul>
                      </li>
                      ...
                      <li className="dropdown-submenu position-relative pb-2">
                        ...
                        <ul className="dropdown-menu position-absolute top-0 start-100 border-0 p-3">
                          <li><a  className="dropdown-item shope " href="#">FAQ 1 </a></li>
                          <li><a className="dropdown-item shope " href="#">FAQ 2</a></li>
                        </ul>
                      </li>
                      ...
                      <li className="dropdown-submenu position-relative pb-2">
                        ...
                        <ul className="dropdown-menu position-absolute top-0 start-100 border-0 p-3">
                          <li><a  className="dropdown-item shope " href="#">Our Stroe </a></li>
                          <li><a className="dropdown-item shope " href="#">Stroe locator</a></li>
                        </ul>
                      </li>

                      {/* Normal Items */}
                      
                      <li><a  className="dropdown-item shope pb-2" href="#">Timeline</a></li>
                      <li><a  className="dropdown-item shope pb-2" href="#">View cart</a></li>
                      <li><a className="dropdown-item shope pb-2" href="#">Check out</a></li>

                      <li className="dropdown-submenu position-relative pb-2">
                        <a  className="dropdown-item shope" href="#">
                          Payment <i className="bi bi-chevron-right float-end"></i>
                        </a>
                        <ul className="dropdown-menu position-absolute top-0 start-100 border-0 p-3">
                          <li><a  className="dropdown-item shope " href="#">Payment Conformation </a></li>
                          <li><a className="dropdown-item shope " href="#">Payment Failure</a></li>
                        </ul>
                      </li>

                      <li className="dropdown-submenu position-relative pb-2">
                        <a  className="dropdown-item shope" href="#">
                          My Account <i className="bi bi-chevron-right float-end"></i>
                        </a>
                        <ul className="dropdown-menu position-absolute top-0 start-100 border-0 p-3">
                          <li><a  className="dropdown-item shope " href="#">My account  </a></li>
                          <li><a className="dropdown-item shope " href="#"> My order</a></li>
                          <li><a className="dropdown-item shope " href="#">MY order details</a></li>
                          <li><a className="dropdown-item shope " href="#">My address</a></li>
                          <li><a className="dropdown-item shope " href="#">My Account details</a></li>
                          <li><a className="dropdown-item shope " href="#">My Wishlist</a></li>

                        </ul>
                      </li>

                      <li><a  className="dropdown-item shope pb-2" href="#">invoice</a></li>
                      <li><a  className="dropdown-item shope pb-2" href="#">404</a></li>
                      <li><a  className="dropdown-item shope pb-2" href="#">icons</a></li>
                    </ul>
                  </li>
...
{/* Blod dropdwoun */}
                  ...
                  >
                   <a className="nav-link text-dark hover" >Blog <i className="bi bi-chevron-down Small"></i></a>


                    <ul
                      className={`dropdown-menu shadow p-4 border-0 mt-0 rounded-0 ${showBlogs ? "d-block" : ""}`}
                      style={{ minWidth: "280px" }}
                    >
                      {/* About us (submenu) */}
          
                      
                      <li><a  className="dropdown-item shope pb-2" href="#">Grid layout</a></li>
                      <li><a  className="dropdown-item shope pb-2" href="#">Left sidebar</a></li>
                      <li><a className="dropdown-item shope pb-2" href="#">Right sidebar</a></li>
                      <li><a  className="dropdown-item shope pb-2" href="#">Blog list</a></li>
                      <li><a  className="dropdown-item shope pb-2" href="#">Single Post</a></li>
                      </ul>
                  </li>
